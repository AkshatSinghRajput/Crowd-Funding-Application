...
const UserState = (props) => {
    ...
    return (<UserContext.Provider value={{ user, setUser, getUserData, alert, showAlert, setStartups, startups, getStartups, setStartupData, startupData, loadRazorpay, setOrderAmount, orderAmount, getUserStartups, userStartup, getInvestmentData, investmentData, paymentSuccess,setPaymentSuccess }}>
        {props.children}
